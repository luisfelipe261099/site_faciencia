...
try {
    ...
    // Configurações SMTP
    $mail->isSMTP();
    $mail->Host       = 'mail.informatech.com.br';
    $mail->SMTPAuth   = true;
    $mail->Username   = 'site@faciencia.com.br';
    $mail->Password   = 'Rk8J#u=+0y';
    ...
    $mailPolo = clone $mail;
    $mailPolo->setFrom('site@faciencia.com.br', 'FaCiencia - Solicitação de Polo');
    ...
    $mailInterno->setFrom('site@faciencia.com.br', 'FaCiencia - Nova Solicitação');
